...
'20221116105843_00004.gif', '4.gif', 3 , 1991);
...
CREATE TABLE INTRODUCE (
	MEMBER_NO NUMBER NOT NULL COMMENT '회원 번호(SEQ_MEMBER_NO)',
	INTRO_CONTENT VARCHAR2(4000) NULL COMMENT '소개 내용'
);

ALTER TABLE `INTRODUCE` ADD CONSTRAINT `PK_INTRODUCE` PRIMARY KEY (
	`MEMBER_NO`
);


ALTER TABLE `INTRODUCE` ADD CONSTRAINT `FK_MEMBER_TO_INTRODUCE_1` FOREIGN KEY (
	`MEMBER_NO`
)
REFERENCES `MEMBER` (
	`MEMBER_NO`
);
COMMENT ON COLUMN "INTRODUCE"."MEMBER_NO" IS '회원 번호(SEQ_MEMBER_NO)';
COMMENT ON COLUMN "INTRODUCE"."INTRO_CONTENT" IS '소개 내용';
...
ALTER TABLE INTRODUCE ADD CONSTRAINT PK_INTRODUCE PRIMARY KEY (MEMBER_NO);

ALTER TABLE INTRODUCE ADD CONSTRAINT FK_MEMBER_TO_INTRODUCE_1 FOREIGN KEY (MEMBER_NO)
